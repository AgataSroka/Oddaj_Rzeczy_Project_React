            ...
            <div className='who_we_help' name="WhoWeHelp">
                <div className='main_help'>
                    ...
                    <div className='buttons'>
                        ...
                        <button className={this.state.border_2} onClick={this.handleClickOrganization}>Organizacjom
                            pozarządowym
                        </button>
                        <button className={this.state.border_3} onClick={this.handleClickLocal}>Lokalnym <br/> zbiórkom
                        </button>
                    </div>
