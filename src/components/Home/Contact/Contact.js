        ...
        return (
            ...
            <div className='contact' name="Contact">
                <div className='main_contact'>
                    ...
                    <br/>
                    {this.state.sendForm &&
                    <span className='form_success'> Wiadomość została wysłana!<br/> Wkrótce się skontaktujemy. </span>}
                    <form onSubmit={this.handleSubmit}>
                        <div className='form_flex'>
                            <div style={{display: 'block'}}>
                                ...
                                <span className='form_valid'> Podane imię jest nieprawidłowe </span>}
                            </div>
                            <div style={{display: 'block'}}>
                        ...
                        <span className='form_valid'> Wiadomość musi mieć conajmniej 120 znaków! </span>}
